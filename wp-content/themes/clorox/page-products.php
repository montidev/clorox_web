...
<section class="bg-blue section "id="section-products">
  <div class="container title text-center with-filters">
    <h2 class="clearfix">
      ...
      <div class="col-md-1 text-center label-filter">mi</div>
      <div class="col-md-2 text-left"><?php get_filter_product_categories_form(); ?></div>
    </h2>
  </div>
